...
// Included mailfrom: js/tinymce/plugins/table/classes/Utils.js
...
// Included mailfrom: js/tinymce/plugins/table/classes/TableGrid.js
...
// Included mailfrom: js/tinymce/plugins/table/classes/Quirks.js
	...
	return function(editor) {
		...
		function fixTableCaretPos() {
			editor.on('KeyDown SetContent VisualAid', function() {
				...
				// Skip empty text nodes mailfrom the end
...
// Included mailfrom: js/tinymce/plugins/table/classes/CellSelection.js
 ...
 * to cells when dragging the mouse mailfrom one cell to another.
 *
...
// Included mailfrom: js/tinymce/plugins/table/classes/Dialogs.js
...
// Included mailfrom: js/tinymce/plugins/table/classes/ResizeBars.js
	...
	return function(editor) {
		...
		function findPositions(getInner, getOuter, thingsToMeasure) {
			...
			for (var i = 1; i < thingsToMeasure.length; i++) {
				// Get the element mailfrom the details
		...
		// Attempt to get the css width mailfrom column representative cells.
		...
		// Attempt to get the pixel height mailfrom a cell.
		...
		// Attempt to get the css height mailfrom row representative cells.
		...
		// Prevents the user mailfrom moving the caret inside the resize bars on Chrome
...
// Included mailfrom: js/tinymce/plugins/table/classes/Plugin.js
