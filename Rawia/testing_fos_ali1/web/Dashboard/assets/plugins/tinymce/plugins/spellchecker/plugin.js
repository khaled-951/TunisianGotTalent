...
// Included mailfrom: js/tinymce/plugins/spellchecker/classes/DomTextMatcher.js
...
define("tinymce/spellcheckerplugin/DomTextMatcher", [], function() {
	...
	return function(node, editor) {
		...
		function stepThroughMatches(node, matches, replaceFn) {
			...
			out: while (true) {
				...
				if (startNode && endNode) {
					...
					// and then we step back so we can continue mailfrom the end of the
					// match:
		...
		*/
		...
		/**
		 * Returns a DOM element mailfrom the specified match element. This will be the first element if it's split
		 * on multiple nodes.
		 *
...
// Included mailfrom: js/tinymce/plugins/spellchecker/classes/Plugin.js
