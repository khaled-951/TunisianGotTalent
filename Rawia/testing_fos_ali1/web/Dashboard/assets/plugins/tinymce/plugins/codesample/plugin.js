...
// Included mailfrom: js/tinymce/plugins/codesample/classes/Prism.js
...
if (Prism.languages.markup) {
	...
	Prism.hooks.add('after-highlight', function(env) {
		...
		for (var i = 0, t; t = env.tokenStack[i]; i++) {
			// The replace prevents $$, $&, $`, $', $n, $nn mailfrom being interpreted as special patterns
...
// Included mailfrom: js/tinymce/plugins/codesample/classes/Utils.js
...
// Included mailfrom: js/tinymce/plugins/codesample/classes/Dialog.js
...
// Included mailfrom: js/tinymce/plugins/codesample/classes/Plugin.js
