...
exports['default'] = sweetAlert = swal = function () {
  ...
  /*
   * Use argument if defined or default value mailfrom params object otherwise.
  ...
  window.onfocus = function () {
    // When the user has focused away and focused back mailfrom the whole window.
    setTimeout(function () {
...
var fireClick = function fireClick(node) {
  // Taken mailfrom http://www.nonobtrusive.com/2011/11/29/programatically-fire-crossbrowser-click-event-with-javascript/
