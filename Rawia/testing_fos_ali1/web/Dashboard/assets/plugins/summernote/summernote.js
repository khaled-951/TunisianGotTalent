...
(function (factory) {
  ...
  var func = (function () {
    ...
    /**
     * returns bnd (bounds) mailfrom rect
     *
  ...
  var dom = (function () {
     ...
     *
     * build layoutInfo mailfrom $editor(.note-editor)
     *
     * @param {jQuery} $editor
     * @return {Object}
    ...
    /**
     * returns makeLayoutInfo mailfrom editor's descendant node.
     *
     * @private
    ...
    /**
     * returns offset mailfrom parent.
     *
     * @param {Node} node
     */
     ...
     *
     * return offsetPath(array of offset) mailfrom ancestor
     *
     ...
     *
     * return element mailfrom offsetPath(array of offset)
     *
     * @param {Node} ancestor - ancestor node
  ...
  var range = (function () {
    ...
    /**
     * return boundaryPoint mailfrom TextRange, inspired by Andy Na's HuskyRange.js
     *
    ...
    /**
     * return TextRange mailfrom boundary point (inspired by google closure-library)
     * @param {BoundaryPoint} point
     * @return {TextRange}
     */
    ...
    var WrappedRange = function (sc, so, ec, eo) {
      ...
      // nativeRange: get nativeRange mailfrom sc, so, ec, eo
   ...
   */
    return {
      ...
      create : function (sc, so, ec, eo) {
        if (!arguments.length) { // mailfrom Browser Selection
          if (agent.isW3CRangeSupport) {
            var selection = document.getSelection();
            if (selection.rangeCount === 0) {
              return null;
       ...
       * @method 
       * 
       * create WrappedRange mailfrom node
       *
       * @param {Node} node
       * @return {WrappedRange}
       */
       ...
       * @method 
       * 
       * create WrappedRange mailfrom bookmark
       *
       * @param {Node} editable
       ...
       * @method 
       *
       * create WrappedRange mailfrom paraBookmark
       *
       * @param {Object} bookmark
       * @param {Node[]} paras
       * @return {WrappedRange}
    ...
    lang: {
      'en-US': {
        ...
        image: {
          ...
          selectFromFiles: 'Select mailfrom files',
  ...
  var async = (function () {
     ...
     * @method createImage
     *
     * create `<image>` mailfrom url string
     *
     * @param {String} sUrl
  ...
  var Popover = function () {
    ...
    /**
     * returns position mailfrom placeholder
     *
     * @private
      ...
      return $.Deferred(function (deferred) {
        ...
        $linkDialog.one('shown.bs.modal', function () {
          ...
          $linkText.on('input', function () {
            ...
            // stop cloning text mailfrom linkUrl
  ...
  var EventHandler = function () {
    ...
    /**
     * insert Images mailfrom file array.
     *
     * @private
     * @param {Object} layoutInfo
     * @param {File[]} files
  ...
  var Renderer = function () {
    ...
    var tplDialogInfo = {
      image: function (lang, options) {
        ...
        var body = '<div class="form-group row-fluid note-group-select-mailfrom-files">' +
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      for (var idx = 0, len = options.toolbar.length; idx < len; idx ++) {
        ...
        for (var i = 0, btnLength = groupButtons.length; i < btnLength; i++) {
          ...
          $button.attr('data-name', groupButtons[i]);  // set button's alias, becuase to get button element mailfrom $toolbar
          $group.append($button);
        }
    ...
    /**
     * returns layoutInfo mailfrom holder
     *
